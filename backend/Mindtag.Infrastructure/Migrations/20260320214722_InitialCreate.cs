        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultLocationLat = table.Column<double>(type: "float", nullable: true),
                    DefaultLocationLng = table.Column<double>(type: "float", nullable: true),
                    LocationName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    AbsenceLimit = table.Column<int>(type: "int", nullable: false),
                    CountLateAsAbsence = table.Column<bool>(type: "bit", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RiskStatus = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    RiskStatusUpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentQrToken = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Sessions_Users_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentScheduleSlots", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StudentScheduleSlots_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_StudentScheduleSlots_Users_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudentLat = table.Column<double>(type: "float", nullable: false),
                    StudentLng = table.Column<double>(type: "float", nullable: false),
                    Distance = table.Column<double>(type: "float", nullable: false),
                    IsSuspicious = table.Column<bool>(type: "bit", nullable: false),
                    SuspiciousReason = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeviceBindings_UserId_IsActive",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sessions_CourseId_Status",
                table: "Sessions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentScheduleSlots_CourseId",
                table: "StudentScheduleSlots",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentScheduleSlots_StudentId",
                table: "StudentScheduleSlots",
                column: "StudentId");
